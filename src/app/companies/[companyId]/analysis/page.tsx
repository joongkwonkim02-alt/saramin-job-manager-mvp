        ...
        <div className="mx-auto max-w-3xl">
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-slate-700">
              ...
              <Link className="font-semibold underline" href="/dashboard?status=approved">
                승인함으로 이동
              </Link>
            </CardContent>
          </Card>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="text-sm text-slate-600">{company.display_name}</p>
          </div>
          <div className="flex items-center gap-2">
            <Badge variant="secondary">template: {template.name}</Badge>
            <Link className="text-sm font-semibold underline" href="/dashboard?status=approved">
              승인함으로 복귀
            </Link>
          </div>
        </header>
